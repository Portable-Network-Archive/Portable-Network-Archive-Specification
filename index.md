...
- [4. Chunk Specifications](./chunk_specifications/index.md)
  ...
  - [4.2. Ancillary chunks](./chunk_specifications/index.md#42-ancillary-chunks)
    ...
    - [4.2.6 owner information](./chunk_specifications/index.md#426-owner-information)
      - [4.2.6.1 fUId Owner user ID](./chunk_specifications/index.md#4261-fuid-owner-user-id)
      - [4.2.6.2 fGId Owner group ID](./chunk_specifications/index.md#4262-fgid-owner-group-id)
      - [4.2.6.3 fONm Owner user name](./chunk_specifications/index.md#4263-fonm-owner-user-name)
      - [4.2.6.4 fGNm Owner group name](./chunk_specifications/index.md#4264-fgnm-owner-group-name)
      - [4.2.6.5 fOSi Owner SID](./chunk_specifications/index.md#4265-fosi-owner-sid)
      - [4.2.6.6 fGSi Owner group SID](./chunk_specifications/index.md#4266-fgsi-owner-group-sid)
      - [4.2.6.7 fMOd POSIX permission mode](./chunk_specifications/index.md#4267-fmod-posix-permission-mode)
...
- [7. Cipher modes](./cipher_modes/index.md)
  ...
  - [7.3. Initialization Vector (IV) Placement in Encrypted Streams](./cipher_modes/index.md#73-initialization-vector-iv-placement-in-encrypted-streams)
    - [7.3.1 Placement](./cipher_modes/index.md#731-placement)
    - [7.3.2 Decoder Behavior](./cipher_modes/index.md#732-decoder-behavior)
    - [7.3.3 Encoder Behavior](./cipher_modes/index.md#733-encoder-behavior)
  - [7.4. Galois/Counter Mode (GCM)](./cipher_modes/index.md#74-galoiscounter-mode-gcm)
    - [7.4.1 Parameters](./cipher_modes/index.md#741-parameters)
  - [7.5. AEAD Datastream Layout](./cipher_modes/index.md#75-aead-datastream-layout)
    - [7.5.1 Stream Header](./cipher_modes/index.md#751-stream-header)
    - [7.5.2 Segments](./cipher_modes/index.md#752-segments)
    - [7.5.3 Nonce Derivation](./cipher_modes/index.md#753-nonce-derivation)
- [8. Key derivation algorithms](./key_derivation_algorithms/index.md)
  ...
  - [8.3. HKDF (AEAD stream key derivation)](./key_derivation_algorithms/index.md#83-hkdf-aead-stream-key-derivation)
...
- [11. Recommendations for Encoders](./recommendations_for_encoders/index.md)
  ...
  - [11.3. Owner information chunks](./recommendations_for_encoders/index.md#113-owner-information-chunks)
  - [11.4. Encryption modes](./recommendations_for_encoders/index.md#114-encryption-modes)
- [12. Recommendations for Decoders](./recommendations_for_decoders/index.md)
  ...
  - [12.3. Owner information chunks](./recommendations_for_decoders/index.md#123-owner-information-chunks)
  - [12.4. AEAD-specific decoder behavior](./recommendations_for_decoders/index.md#124-aead-specific-decoder-behavior)
    - [12.4.1 Unauthenticated metadata](./recommendations_for_decoders/index.md#1241-unauthenticated-metadata)
